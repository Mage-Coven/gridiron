...
import (
	...
	"github.com/mage-coven/gridiron/x/poe/client/cli"
)
...
func (ac appCreator) appExport(
	...
	var gridironApp *app.GridironApp
	...
	loadLatest := height == -1
	var emptyWasmOpts []wasm.Option
	gridironApp = app.NewGridironApp(
		logger,
		db,
		traceStore,
		loadLatest,
