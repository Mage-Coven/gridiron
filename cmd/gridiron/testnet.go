...
import (
	...
	poeclient "github.com/mage-coven/gridiron/x/poe/client"
...
func testnetCmd(mbm module.BasicManager, genBalIterator banktypes.GenesisBalancesIterator) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a gridiron testnet",
...
Example:
	gridiron testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "gridiron", "Home directory of the node's daemon configuration")
