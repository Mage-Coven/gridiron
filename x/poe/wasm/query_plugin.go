...
func CustomQuerier(poeKeeper ViewKeeper) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		var contractQuery GridironQuery
		if err := json.Unmarshal(request, &contractQuery); err != nil {
			return nil, sdkerrors.Wrap(err, "gridiron query")
		}
...
func handlePoEContractAddressQuery(ctx sdk.Context, contractQuery GridironQuery, poeKeeper ViewKeeper) ([]byte, error) {
