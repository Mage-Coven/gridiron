...
import (
	...
	poecontracts "github.com/mage-coven/gridiron/x/poe/contract"
...
Example:
$ gridiron tx poe create-validator \
	--amount 1000ufury \
	--vesting-amount 1000ufury \
	--from gridiron1n4kjhlrpapnpv0n0e3048ydftrjs9m6mm473jf \
	--pubkey gridironvalconspub1zcjduepqu7xf85mmfyv5p9m8mc6wk0u0pcjwcpr9p8wsv4h96dhpxqyxs4uqv06vlq \
	--home $APP_HOME \
	--chain-id=gridiron-int \
    --moniker="myvalidator" \
    --details="..." \
    --security-contact="..." \
    --website="..." \
...
Example:
$ %s tx poe set-withdraw-address gridiron1n4kjhlrpapnpv0n0e3048ydftrjs9m6mm473jf`, version.AppName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
				return err
