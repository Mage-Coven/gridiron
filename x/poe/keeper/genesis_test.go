	...
	specs := map[string]struct {
		...
		"all good": {
			src: types.GenesisStateFixture(func(m *types.GenesisState) {
				m.GetSeedContracts().GenTxs = []json.RawMessage{[]byte(`{"body":{"messages":[{"@type":"/mage-coven.poe.v1beta1.MsgCreateValidator","description":{"moniker":"moniker-0","identity":"","website":"","security_contact":"","details":""},"operator_address":"gridiron18katt8evmwr7g0w545g9kgrn2s6z9a0ky27gdp","pubkey":{"@type":"/cosmos.crypto.ed25519.PubKey","key":"P4qRtdI2pfl5IZN4cv28uuFhsRhSc/CBzrlB2/+ATQs="},"amount":{"denom":"ufury","amount":"100000000"},"vesting_amount":{"denom":"ufury","amount":"0"}}],"memo":"7973f9800a585f9a5e730ee18e4abab9a06214f5@192.168.178.24:16656","timeout_height":"0","extension_options":[],"non_critical_extension_options":[]},"auth_info":{"signer_infos":[{"public_key":{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AlOUwEtcgY5rV6cJHCJJntNdrY9Kpe057pY6yewFbhxW"},"mode_info":{"single":{"mode":"SIGN_MODE_DIRECT"}},"sequence":"0"}],"fee":{"amount":[],"gas_limit":"0","payer":"","granter":""}},"signatures":["cJnG18yHwWsgxjh1Kqf3j/MFv7OpX69c7VLQz1MX1qtndFIylSNPVbkXOMu2i+Ufy52nXH3yujOKsMIVLP62pg=="]}`)}
			},
			),
...
func TestDeliverGenTxs(t *testing.T) {
	...
	specs := map[string]struct {
		...
		"valid tx": {
			src:               []json.RawMessage{[]byte(`{"body":{"messages":[{"@type":"/mage-coven.poe.v1beta1.MsgCreateValidator","description":{"moniker":"moniker-0","identity":"","website":"","security_contact":"","details":""},"operator_address":"gridiron18katt8evmwr7g0w545g9kgrn2s6z9a0ky27gdp","pubkey":{"@type":"/cosmos.crypto.ed25519.PubKey","key":"P4qRtdI2pfl5IZN4cv28uuFhsRhSc/CBzrlB2/+ATQs="},"amount":{"denom":"ufury","amount":"100000000"},"vesting_amount":{"denom":"ufury","amount":"0"}}],"memo":"7973f9800a585f9a5e730ee18e4abab9a06214f5@192.168.178.24:16656","timeout_height":"0","extension_options":[],"non_critical_extension_options":[]},"auth_info":{"signer_infos":[{"public_key":{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AlOUwEtcgY5rV6cJHCJJntNdrY9Kpe057pY6yewFbhxW"},"mode_info":{"single":{"mode":"SIGN_MODE_DIRECT"}},"sequence":"0"}],"fee":{"amount":[],"gas_limit":"0","payer":"","granter":""}},"signatures":["cJnG18yHwWsgxjh1Kqf3j/MFv7OpX69c7VLQz1MX1qtndFIylSNPVbkXOMu2i+Ufy52nXH3yujOKsMIVLP62pg=="]}`)},
			expDeliveredCount: 1,
		},
		"multiple valid tx": {
			src: []json.RawMessage{
				[]byte(`{"body":{"messages":[{"@type":"/mage-coven.poe.v1beta1.MsgCreateValidator","description":{"moniker":"moniker-0","identity":"","website":"","security_contact":"","details":""},"operator_address":"gridiron18katt8evmwr7g0w545g9kgrn2s6z9a0ky27gdp","pubkey":{"@type":"/cosmos.crypto.ed25519.PubKey","key":"P4qRtdI2pfl5IZN4cv28uuFhsRhSc/CBzrlB2/+ATQs="},"amount":{"denom":"ufury","amount":"100000000"},"vesting_amount":{"denom":"ufury","amount":"0"}}],"memo":"7973f9800a585f9a5e730ee18e4abab9a06214f5@192.168.178.24:16656","timeout_height":"0","extension_options":[],"non_critical_extension_options":[]},"auth_info":{"signer_infos":[{"public_key":{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AlOUwEtcgY5rV6cJHCJJntNdrY9Kpe057pY6yewFbhxW"},"mode_info":{"single":{"mode":"SIGN_MODE_DIRECT"}},"sequence":"0"}],"fee":{"amount":[],"gas_limit":"0","payer":"","granter":""}},"signatures":["cJnG18yHwWsgxjh1Kqf3j/MFv7OpX69c7VLQz1MX1qtndFIylSNPVbkXOMu2i+Ufy52nXH3yujOKsMIVLP62pg=="]}`),
				[]byte(`{"body":{"messages":[{"@type":"/mage-coven.poe.v1beta1.MsgCreateValidator","description":{"moniker":"node001","identity":"","website":"","security_contact":"","details":""},"operator_address":"gridiron15esst7gqck0uhmk9ppvllut55ayx4tte97f6an","pubkey":{"@type":"/cosmos.crypto.ed25519.PubKey","key":"39iF6mDX3F99NpqdS07bkpxWNQsWjhrXCdh6iYZ2em8="},"amount":{"denom":"ufury","amount":"0"},"vesting_amount":{"denom":"ufury","amount":"250000000"}}],"memo":"8bdd68de6f52e438f877915d550639a2e5a38a27@192.168.178.24:26656","timeout_height":"0","extension_options":[],"non_critical_extension_options":[]},"auth_info":{"signer_infos":[{"public_key":{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"A0sF4hqaQLQCH4l/vxAEyl/IUwcEJcQtkEiVu/i7gDP2"},"mode_info":{"single":{"mode":"SIGN_MODE_DIRECT"}},"sequence":"0"}],"fee":{"amount":[],"gas_limit":"200000","payer":"","granter":""}},"signatures":["0+lWFkn76yLiMldaK/nfeuByyctt48DW7QJp5SlQWTFcjEq7nd5mmwJxKH41Aidf0aTBH0iDBWJy7M3ZsMWKHQ=="]}`),
			},
			expDeliveredCount: 2,
		},
		"invalid json": {
