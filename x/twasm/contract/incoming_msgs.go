...
func (p *ExecuteGovProposal) unpackInterfaces(unpacker codectypes.AnyUnpacker) error {
	...
	case p.Proposal.RegisterUpgrade != nil:
		// revisit with https://github.com/mage-coven/gridiron/issues/364
...
// proposalContent contains the concrete cosmos-sdk/ gridiron gov proposal types
type proposalContent struct {
	...
	// See https://github.com/mage-coven/gridiron/blob/privileged_contracts_5/proto/mage-coven/twasm/v1beta1/proposal.proto
...
// See https://github.com/mage-coven/gridiron-contracts/blob/main/packages/bindings/schema/gridiron_msg.json
