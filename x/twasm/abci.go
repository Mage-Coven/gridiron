...
import (
	...
	"github.com/mage-coven/gridiron/x/twasm/keeper"
...
func BeginBlocker(ctx sdk.Context, k abciKeeper, b abci.RequestBeginBlock) {
	...
	msg := contract.GridironSudoMsg{BeginBlock: &contract.BeginBlock{
		Evidence: evidence,
	}}
...
func EndBlocker(ctx sdk.Context, k abciKeeper) []abci.ValidatorUpdate {
	...
	sudoMsg := contract.GridironSudoMsg{EndBlock: &struct{}{}}
