...
// GridironWasmHandlerKeeper defines a subset of Keeper
type GridironWasmHandlerKeeper interface {
	...
	setContractDetails(ctx sdk.Context, contract sdk.AccAddress, details *types.GridironContractDetails) error
...
var _ wasmkeeper.Messenger = GridironHandler{}

// GridironHandler is a custom message handler plugin for wasmd.
type GridironHandler struct {
	cdc                    codec.Codec
	keeper                 GridironWasmHandlerKeeper
	bankKeeper             bankKeeper
	govRouter              govtypes.Router
	consensusParamsUpdater ConsensusParamsUpdater
}

// NewGridironHandler constructor
func NewGridironHandler(
	cdc codec.Codec,
	keeper GridironWasmHandlerKeeper,
	bankKeeper bankKeeper,
	consensusParamsUpdater ConsensusParamsUpdater,
...
func (h GridironHandler) DispatchMsg(ctx sdk.Context, contractAddr sdk.AccAddress, _ string, msg wasmvmtypes.CosmosMsg) ([]sdk.Event, [][]byte, error) {
	if msg.Custom == nil {
...
func (h GridironHandler) handlePrivilege(ctx sdk.Context, contractAddr sdk.AccAddress, msg *contract.PrivilegeMsg) error {
...
func (h GridironHandler) handleGovProposalExecution(ctx sdk.Context, contractAddr sdk.AccAddress, exec *contract.ExecuteGovProposal) error {
...
func (h GridironHandler) handleMintToken(ctx sdk.Context, contractAddr sdk.AccAddress, mint *contract.MintTokens) ([]sdk.Event, error) {
...
func (h GridironHandler) handleConsensusParamsUpdate(ctx sdk.Context, contractAddr sdk.AccAddress, pUpdate *contract.ConsensusParamsUpdate) ([]sdk.Event, error) {
...
func (h GridironHandler) handleDelegate(ctx sdk.Context, contractAddr sdk.AccAddress, delegate *contract.Delegate) ([]sdk.Event, error) {
...
func (h GridironHandler) handleUndelegate(ctx sdk.Context, contractAddr sdk.AccAddress, undelegate *contract.Undelegate) ([]sdk.Event, error) {
	if err := h.assertHasPrivilege(ctx, contractAddr, types.PrivilegeDelegator); err != nil {
		return nil, err
	}
...
func (h GridironHandler) assertHasPrivilege(ctx sdk.Context, contractAddr sdk.AccAddress, requiredPrivilege types.PrivilegeType) error {
	contractInfo := h.keeper.GetContractInfo(ctx, contractAddr)
	if contractInfo == nil {
		return sdkerrors.Wrap(wasmtypes.ErrNotFound, "contract info")
	}
