...
// source: mage-coven/twasm/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*PromoteToPrivilegedContractProposal)(nil), "mage-coven.twasm.v1beta1.PromoteToPrivilegedContractProposal")
	proto.RegisterType((*DemotePrivilegedContractProposal)(nil), "mage-coven.twasm.v1beta1.DemotePrivilegedContractProposal")
}

func init() {
	proto.RegisterFile("mage-coven/twasm/v1beta1/proposal.proto", fileDescriptor_77ea8b6359ab7726)
}
