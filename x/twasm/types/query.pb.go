...
// source: mage-coven/twasm/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryPrivilegedContractsRequest)(nil), "mage-coven.twasm.v1beta1.QueryPrivilegedContractsRequest")
	proto.RegisterType((*QueryPrivilegedContractsResponse)(nil), "mage-coven.twasm.v1beta1.QueryPrivilegedContractsResponse")
	proto.RegisterType((*QueryContractsByPrivilegeTypeRequest)(nil), "mage-coven.twasm.v1beta1.QueryContractsByPrivilegeTypeRequest")
	proto.RegisterType((*QueryContractsByPrivilegeTypeResponse)(nil), "mage-coven.twasm.v1beta1.QueryContractsByPrivilegeTypeResponse")
}

func init() { proto.RegisterFile("mage-coven/twasm/v1beta1/query.proto", fileDescriptor_1dcfe179625ad95e) }
...
func (c *queryClient) PrivilegedContracts(ctx context.Context, in *QueryPrivilegedContractsRequest, opts ...grpc.CallOption) (*QueryPrivilegedContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage-coven.twasm.v1beta1.Query/PrivilegedContracts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ContractsByPrivilegeType(ctx context.Context, in *QueryContractsByPrivilegeTypeRequest, opts ...grpc.CallOption) (*QueryContractsByPrivilegeTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage-coven.twasm.v1beta1.Query/ContractsByPrivilegeType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_PrivilegedContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage-coven.twasm.v1beta1.Query/PrivilegedContracts",
	}
...
func _Query_ContractsByPrivilegeType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage-coven.twasm.v1beta1.Query/ContractsByPrivilegeType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage-coven.twasm.v1beta1.Query",
	...
	Metadata: "mage-coven/twasm/v1beta1/query.proto",
}
