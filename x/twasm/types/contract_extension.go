...
func (d *GridironContractDetails) AddRegisteredPrivilege(t PrivilegeType, pos uint8) {
...
func (d *GridironContractDetails) RemoveRegisteredPrivilege(t PrivilegeType, pos uint8) {
...
func (d *GridironContractDetails) HasRegisteredPrivilege(c PrivilegeType) bool {
...
func (d GridironContractDetails) IterateRegisteredPrivileges(cb func(c PrivilegeType, pos uint8) bool) {
	for _, v := range d.RegisteredPrivileges {
...
func (d GridironContractDetails) ValidateBasic() error {
