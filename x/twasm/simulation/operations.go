...
import (
	...
	"github.com/mage-coven/gridiron/app/params"
...
func WeightedOperations(
	...
	return simulation.WeightedOperations{
		...
		simulation.NewWeightedOperation(
			...
			wasmsimulation.SimulateMsgInstantiateContract(ak, bk, wasmKeeper, GridironSimulationCodeIDSelector),
		),
		simulation.NewWeightedOperation(
			...
			wasmsimulation.SimulateMsgExecuteContract(
				...
				bk,
				wasmKeeper,
				GridironSimulationExecuteContractSelector,
