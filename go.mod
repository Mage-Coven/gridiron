module github.com/mage-coven/gridiron
...
require (
	...
	github.com/mage-coven/ics23/go v0.7.0 // indirect
...
replace (
	...
	// fix for dragonberry
	github.com/mage-coven/ics23/go => github.com/cosmos/cosmos-sdk/ics23/go v0.8.0
