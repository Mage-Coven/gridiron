...
import (
	...
	testingcontract "github.com/mage-coven/gridiron/testing/contract"
...
func TestProofOfEngagementSetup(t *testing.T) {
	...
	// `gridiron wasm-genesis-message list-contracts --home ./testnet/node0/gridiron`
	...
	sut.withEachNodeHome(func(i int, home string) {
		clix := NewGridironCliX(t, sut.rpcAddr, sut.chainID, filepath.Join(workDir, home), verbose)
