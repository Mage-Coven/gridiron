...
import (
	...
	v2 "github.com/mage-coven/gridiron/app/upgrades/v2"
	...
	appparams "github.com/mage-coven/gridiron/app/params"
	"github.com/mage-coven/gridiron/x/globalfee"
	"github.com/mage-coven/gridiron/x/poe"
	poekeeper "github.com/mage-coven/gridiron/x/poe/keeper"
	poestakingadapter "github.com/mage-coven/gridiron/x/poe/stakingadapter"
	poetypes "github.com/mage-coven/gridiron/x/poe/types"
	"github.com/mage-coven/gridiron/x/twasm"
	twasmkeeper "github.com/mage-coven/gridiron/x/twasm/keeper"

	// unnamed import of statik for swagger UI support
	_ "github.com/cosmos/cosmos-sdk/client/docs/statik"
)

const appName = "gridiron"
...
func NewGridironApp(
	...
	availableCapabilities := "staking,stargate,iterator,gridiron,cosmwasm_1_1"
	...
	if manager := app.SnapshotManager(); manager != nil {
		err := manager.RegisterExtensions(
			NewGridironSnapshotter(app, app.CommitMultiStore(), &app.twasmKeeper.Keeper),
		)
		if err != nil {
...
func (app *GridironApp) Name() string { return app.BaseApp.Name() }
...
func (app *GridironApp) getSubspace(moduleName string) paramstypes.Subspace {
...
func (app *GridironApp) setupUpgradeHandlers() {
