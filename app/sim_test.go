...
import (
	...
	twasmtypes "github.com/mage-coven/gridiron/x/twasm/types"
)
...
func TestAppImportExport(t *testing.T) {
	...
	app := NewGridironApp(logger, db, nil, true, map[int64]bool{}, dir, simapp.FlagPeriodValue, encConf, EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
	...
	newApp := NewGridironApp(logger, newDB, nil, true, map[int64]bool{}, newDir, simapp.FlagPeriodValue, encConf, EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
...
func prepareWasmStorage(ctxA sdk.Context, app *GridironApp, ctxB sdk.Context, newApp *GridironApp) {
	...
	normalizeContractInfo := func(ctx sdk.Context, app *GridironApp) {
		var index uint64
	...
	dropExportImportPrivilegedState := func(ctx sdk.Context, xapp *GridironApp) {
	...
	// delete admin until fixed: https://github.com/mage-coven/poe-contracts/issues/139
...
func TestFullAppSimulation(t *testing.T) {
	...
	encConf := MakeEncodingConfig()
	app := NewGridironApp(logger, db, nil, true, map[int64]bool{}, t.TempDir(), simapp.FlagPeriodValue,
		encConf, simapp.EmptyAppOptions{}, nil, fauxMerkleModeOpt)
	require.Equal(t, "gridiron", app.Name())
	app.sm.Modules = append(app.sm.Modules, nonSimModuleSetup{})
